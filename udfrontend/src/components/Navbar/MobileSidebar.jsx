...
const MobileSidebar = ({ open, setOpen }) => {
  ...
  try {
    ...
    await fetch("https://minipro-519d.onrender.com/api/logout/", {
      method: "POST",
      headers: {
    ...
    <>
      ...
      >
        ...
        <div className="p-4 flex items-center gap-3 border-b">
          ...
          />
          <div>
            <p className="font-semibold">Devanshu Gupta</p>
        ...
        <div className="border-t p-4">
          <button
            ...
            className="w-full flex items-center gap-3 p-3 rounded-lg hover:bg-red-50 text-red-600 font-medium transition"
          >
